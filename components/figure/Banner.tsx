...
export const InformationBanner: React.FC = () => (
    ...
    <div className="container items-center gap-10">
           ...
           <span className="font-light"> You can now scan the QR code on your .oa document via camera or barcode scanner 🎉</span>
          <Link href="/qr">
            <a
                        className="text-indigo-800 underline visited:text-indigo-200 font-bold"
                        target="_blank"
