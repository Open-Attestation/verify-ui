...
export const serviceDoc = {
    "Description of Service": [
        <Fragment><b>Name of Service</b>: Verify</Fragment>
    ],
    ...
    "Third party software/services": [
        <a href="www.google.com/policies/privacy/partners/" className="underline text-blue-600">Google Analytics</a>,
        "WoGAA",
        <a href="https://infura.io/terms" className="underline text-blue-600">Infura</a>,
        <a href="https://aws.amazon.com/service-terms/" className="underline text-blue-600">Terms relating to AWS Lambda</a>,
        <a href="https://www.netlify.com/tos/" className="underline text-blue-600">Netlify</a>,
